...
<body>
    ...
    <div class="container">
        <div class="main-content">
            ...
            <p style="color:#888; font-size:14px; margin-bottom:20px;">Diposting pada {{ \Carbon\Carbon::parse($berita->created_at)->format('d F Y') }}</p>
            <div class="news-body">
        ...
        <aside>
            <div class="sidebar-widget">
                ...
                <div class="recent-item">
                    ...
                    <div>
                        <a href="{{ route('informasi.berita.show', $post->slug) }}">{{ Str::limit($post->judul, 40) }}</a>
                        <br><small style="color:#999;">{{ \Carbon\Carbon::parse($post->created_at)->format('d M Y') }}</small>
                    </div>
                </div>
                @endforeach
            </div>
