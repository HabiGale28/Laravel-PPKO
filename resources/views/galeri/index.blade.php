        ...
        <div class="nav-container">
            ...
            <nav>
                <ul class="nav-menu">
                    ...
                    @auth
                        <li><a href="{{ route('admin.dashboard') }}" class="admin-login-btn">Panel Admin</a></li>
                    @else
                        <li><a href="{{ route('login') }}" class="admin-login-btn">🔐 Admin</a></li>
                    @endauth
                </ul>
            </nav>
        </div>
            ...
            <div class="album-grid">
                ...
                <div class="album-card">
                    ...
                    <div class="album-content">
                        ...
                        <p>{{ $album->fotos_count }} Foto</p>
                        <a href="{{ route('galeri.show', $album->slug) }}" class="btn-lihat">Lihat Album</a>
                    </div>
                </div>
                @endforeach
            </div>
