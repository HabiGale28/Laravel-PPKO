...
<head>
    ...
    <title><?php echo e($album->nama_album); ?> - Galeri Wonderful Indonesia</title>
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .album-hero {
            height: 60vh;
            background-image: url('<?php echo e(asset('uploads/albums/'.$album->cover_album)); ?>');
...
<body>
    ...
    <div class="album-hero">
        <div class="hero-content">
            <h1><?php echo e($album->nama_album); ?></h1>
            <p><?php echo e($album->deskripsi); ?></p>
        </div>
    </div>

    <div class="container">
        <a href="<?php echo e(route('galeri.index')); ?>" class="back-btn">← Kembali ke Daftar Album</a>
        ...
        <?php if($fotos->count() > 0): ?>
            <div class="photo-grid">
                ...
                <div class="photo-item">
                    <img src="<?php echo e(asset('uploads/fotos/'.$foto->file_foto)); ?>" alt="<?php echo e($foto->judul_foto); ?>">
                    <?php if($foto->judul_foto): ?>
                    <div class="photo-caption">
                        <span><?php echo e($foto->judul_foto); ?></span>
                    </div>
                    <?php endif; ?>
                </div>
...
</html><?php /**PATH C:\xampp\htdocs\wonderful-indonesia-laravel\resources\views/galeri/show.blade.php ENDPATH**/ ?>