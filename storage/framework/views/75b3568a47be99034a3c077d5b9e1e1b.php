        ...
        <?php if($kebudayaan->count() > 0): ?>
            <div class="culture-grid">
                ...
                <div class="culture-card">
                    <img src="<?php echo e(asset('uploads/kebudayaan/'.$item->gambar)); ?>" alt="<?php echo e($item->judul); ?>">
                    <div class="card-overlay">
                        <div class="card-category"><?php echo e($item->kategori); ?></div>
                        <div class="card-title"><?php echo e($item->judul); ?></div>
                        <div class="card-desc"><?php echo e(Str::limit($item->deskripsi, 80)); ?></div>
                    </div>
                </div>
