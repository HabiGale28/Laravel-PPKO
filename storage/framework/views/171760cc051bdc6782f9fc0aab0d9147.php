    ...
    <div class="container">
        ...
        <div class="pengumuman-list">
            ...
            <div class="pengumuman-card">
                <div class="p-date">
                    <span style="font-size: 28px; font-weight: bold;"><?php echo e(\Carbon\Carbon::parse($item->tanggal_publish)->format('d')); ?></span>
                    <span style="font-size: 12px; text-transform: uppercase;"><?php echo e(\Carbon\Carbon::parse($item->tanggal_publish)->format('M Y')); ?></span>
                </div>
                <div class="p-content">
                    <div class="p-title"><?php echo e($item->judul); ?></div>
                    <p style="font-size: 14px; color: #666; margin-bottom: 10px;"><?php echo e(Str::limit(strip_tags($item->konten), 150)); ?></p>
        ...
        <div class="event-grid">
            ...
            <div class="event-card">
                <div class="event-img" style="background-image: url('<?php echo e($item->gambar ? asset('uploads/event/'.$item->gambar) : 'https://via.placeholder.com/400x300?text=Event'); ?>');"></div>
                <div class="event-info">
                    ...
                    <a href="<?php echo e(route('informasi.event.show', $item->slug)); ?>" class="event-title"><?php echo e($item->judul); ?></a>
                    <div style="font-size: 13px; color: #94a3b8; margin-top: 5px;">📍 <?php echo e($item->lokasi ?? 'Online'); ?></div>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        ...
        <div class="berita-grid">
            ...
            <div class="berita-card">
                ...
                <div class="berita-body">
                    <div style="font-size: 12px; color: #888; margin-bottom: 10px;"><?php echo e(\Carbon\Carbon::parse($item->created_at)->format('d F Y')); ?></div>
